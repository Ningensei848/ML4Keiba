...
```json
{
  ...
  "@id": "race_id:202008030411",
  "@type": "wd:Q187916",
  "title": "第161回天皇賞(春)(G1)",
  "outer_loop": true,
  "field": "wd:Q43238#Sports_turf",
  "direction": "wd:Q14565199",
  "distance": "3200",
  "weather": "wd:Q1055865",
  "going": "良",
  "start_at": "15:40",
...
- `runner_list` と `runner` は区別せずに，直接 `runner` オブジェクトのリストを作るべき（JSON を要素とする Array をつくる）
- 「出走馬」みたいなスキーマを持ってくる

<details>
<summary>read more ... (Underconstruction)</summary>
